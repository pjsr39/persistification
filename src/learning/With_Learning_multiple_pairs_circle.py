...
E_charge = 5000
E_min = 3600
r = 1.5  # radius for tracking circles
d_charge = 0.2  # charging distance threshold

# Positioning parameters for pairs
pair_positions = {
    0: {'Xc1': 8, 'Yc1': 14, 'Xc2': 8, 'Yc2': 7, 'x_cs': 8, 'y_cs': 10.5},
    1: {'Xc1': 4, 'Yc1': 14, 'Xc2': 4, 'Yc2': 7, 'x_cs': 4, 'y_cs': 10.5},
    2: {'Xc1': 0,  'Yc1': 14, 'Xc2': 0,  'Yc2': 7, 'x_cs': 0,  'y_cs': 10.5},
    3: {'Xc1': -4,  'Yc1': 14, 'Xc2': -4,  'Yc2': 7, 'x_cs': -4,  'y_cs': 10.5},
    4: {'Xc1': -8,  'Yc1': 14, 'Xc2': -8,  'Yc2': 7, 'x_cs': -8,  'y_cs': 10.5}
}
...
def read_csv_files():
    ...
    for i in range(num_pairs):
        if i == 0:
            filename = 'first pair/results_with_learning_first_pair.csv'
        elif i == 1:
            filename = 'second pair/results_with_learning_second_pair.csv'
        elif i == 2:
            filename = 'third pair/results_with_learning_third_pair.csv'
        elif i == 3:
            filename = 'fourth pair/results_with_learning_fourth_pair.csv'
        elif i == 4:
            filename = 'fifth pair/results_with_learning_fifth_pair.csv'
...
def initialize_plot_elements(ax):
    ...
    for i in range(num_pairs):
        ...
        # Tracking circles
        circ_i = Circle((pos['Xc1'], pos['Yc1']), r, color='black', fill=False, linestyle='--', alpha=0.7)
        circ_d = Circle((pos['Xc2'], pos['Yc2']), r, color='blue', fill=False, linestyle='--', alpha=0.7)
        # circ_cs = Circle((pos['x_cs'], pos['y_cs']), radius=0.1, color='lightgreen', fill=False, linewidth=2, linestyle=':')
        ...
        # Pair labels
        label = ax.text(pos['Xc1'], pos['Yc1'] + r + 1.5, f'Pair {i+1}', 
